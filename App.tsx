...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    return () => clearInterval(timer); // 離開頁面時清除計時器
  }, [stage]);
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-[#060b28] select-none font-sans">
